  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="h-12 px-6 text-lg font-bold uppercase tracking-wide border-4 border-foreground bg-secondary text-secondary-foreground hover:bg-secondary/80 hover:translate-x-1 hover:translate-y-1 hover:shadow-none shadow-md transition-all">
